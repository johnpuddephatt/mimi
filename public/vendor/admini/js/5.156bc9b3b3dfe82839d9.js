...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    populateData: function populateData(fields, entry) {
      this.form = new _core_Form__WEBPACK_IMPORTED_MODULE_0__["default"](fields, entry);
    ...
    [
      ...
      _c(
          ...
          scopedSlots: _vm._u([
            {
              ...
              fn: function(props) {
                return _c(
                  "a",
                  { attrs: { "aria-controls": "contentIdForA11y1" } },
                  [
                    _c("b-icon", {
                      attrs: { icon: !props.open ? "menu-down" : "menu-up" }
                    }),
                    _vm._v(
                      "\n      " +
                        _vm._s(!props.open ? "All options" : "Fewer options") +
                        "\n    "
                    )
                  ],
                  1
        ...
        [
          _vm._v(" "),
          _c("pre", [
            _c("code", { staticClass: "JSON" }, [_vm._v(_vm._s(_vm.form))])
          ])
        ]
      )
    ],
